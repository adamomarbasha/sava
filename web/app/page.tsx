    ...
    <nav className="navbar">
      <div className="max-w-7xl mx-auto px-6 py-3 w-full flex justify-between items-center">
        <div className="flex items-center gap-4">
          ...
          />
          <span className="logo-font text-2xl text-gray-900 font-bold">Sava</span>
        </div>
        <div className="flex items-center gap-3">
          <span className="hidden sm:block text-sm text-gray-700 font-medium px-4 py-2 rounded-full bg-gray-100/80">
            {user?.email}
          </span>
          <button 
            onClick={logout} 
            className="px-4 py-2 rounded-full bg-gray-900 text-white text-sm font-medium hover:bg-gray-800 transition-all duration-200 hover:scale-105 shadow-sm"
          >
            Logout
          </button>
        </div>

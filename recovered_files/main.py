...
function getThumbnail(url: string, platform?: string, bookmark?: any): string | null {
  ...
  if (platform === "tiktok" && bookmark?.thumbnail_url) {
...
function getVideoAspectRatio(platform: string, bookmark?: any): string {
  if (platform === "tiktok") {
    ...
    const width = bookmark?.platform_specific?.video_width;
    const height = bookmark?.platform_specific?.video_height;
        ...
        <div className="mb-8">
          ...
          >
            {filtered.map((bm) => {
              ...
              const aspectRatio = getVideoAspectRatio(bm.platform || 'web', bm as any);
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <div className="flex-1 px-4">
                        ...
                        >
                          <div className={`${
                            bm.platform === 'tiktok' 
                              ? (aspectRatio === 'aspect-[16/9]' ? 'w-full h-[160px]' : 'w-[140px] mx-auto')
                              : 'w-full h-full aspect-video'
                          } ${bm.platform === 'tiktok' ? aspectRatio : ''} overflow-hidden rounded-md bg-gray-100`}>
                            {bm.platform === "youtube" ? (
                              (() => {
